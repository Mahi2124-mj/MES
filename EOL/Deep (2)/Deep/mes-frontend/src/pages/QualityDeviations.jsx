                    ...
                    <tbody>
                      {deviations.map(d => (
                        <tr key={d.id} style={{borderBottom:"1px solid #f1f5f9"}}>
                          ...
                          <td className="qd-td">
                            <div style={{fontWeight:700}}>{d.line_name || "—"}</div>
                      ...
                      {fourMs.map(n => {
                        ...
                        return (
                          <tr key={n.id} style={{borderBottom:"1px solid #f1f5f9"}}>
                            ...
                            <td className="qd-td">
                              <div style={{fontWeight:700}}>{n.line_name || "—"}</div>
                      ...
                      <tbody>
                        {flpRows.map(r => (
                          <tr key={r.id} style={{borderBottom:"1px solid #f1f5f9",
                            ...
                            <td className="qd-td">
                              <div style={{fontWeight:700}}>{r.line_name || "—"}</div>
    ...
    <ModalShell title={`Close ${ncr.ncr_number}`} theme={theme} onClose={onClose}>
      ...
      <div style={{padding:12, background:"#f8fafc", borderRadius:8, marginBottom:14,
        ...
        <div style={{display:"grid", gridTemplateColumns:"repeat(3, 1fr)", gap:10, fontSize:12}}>
          <div>
            <div className="qd-label">Line</div>
            <div style={{fontWeight:700}}>{ncr.line_name || "—"}</div>
          </div>
          <div>
