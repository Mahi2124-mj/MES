...
CONFIG = {
    "line_id":    15,
    "line_name":  "Y17-SS",
    "table_name": "y17_l7_complete",
    "plc_ip":     "192.168.30.176",
    "plc_port":   5002,
    "ok_bit":     "D101",
    "ng_bit":     "D102",
    "status_addr":"D6005",
    ...
    "ideal_ct":   15.0,
    "max_ct":     16.0,
    "models":     {9: 'TRACK ASSY FRONT SEAT YHB 4 WAY OTR', 14: 'TRACK ASSY FRONT SEAT 4 WAY INR RH', 15: 'TRACK ASSY FRONT SEAT YTA 4 WAY INR LH', 20: 'TRACK ASSY FRONT SEAT Y17 6 WAY INR RH', 21: 'TRACK ASSY FRONT SEAT Y17 6 WAY INR LH', 22: 'TRACK ASSY FRONT SEAT YED 6 WAY OTR RH', 23: 'TRACK ASSY FRONT SEAT YED 6 WAY OTR LH'},
