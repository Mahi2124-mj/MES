...
def page_purpose(pdf):
    ...
    stages = [
        ("PLC", "Mitsubishi MC4E\n(192.168.30.150)",       NAVY,  6,  18, 14, 8),
        ("COLLECTOR", "Python\npolls every 30 ms",         BLUE, 24,  18, 14, 8),
        ("DATABASE",  "PostgreSQL\n(192.168.30.10)",      GREEN, 42, 18, 14, 8),
    ...
    # Bottom note
    caption(ax, 50, 14, "End-to-end latency: ~1-2 seconds.  All on one server PC for now (192.168.30.185).",
...
def page_architecture(pdf):
    ...
    layers = [
        ...
        (46, 9, "1", "PHYSICAL",
            ...
            GREY,    LIGHT_K,
            [("Main PLC",    "192.168.30.150", NAVY),
             ("Sub-PLCs ×3", ".190 / .191 / .192", ROYAL),
             ("Camera",      "192.168.30.115", "#5E548E"),
...
def page_network(pdf):
    ...
    nodes = [
        ...
        (15, 56, 22, 8, "Server PC",          BLUE,  "192.168.30.185\n(MES + CMS host)",       "8080 · 5656 · 5000 · 8050 · 5173"),
        (63, 56, 22, 8, "PostgreSQL",         GREEN, "192.168.30.10",                          "5432  ·  energydb"),
        ( 6, 36, 18, 8, "Main PLC",           NAVY,  "192.168.30.150",                          "5002  ·  MC4E"),
        (76, 36, 18, 8, "Camera (final)",     "#5E548E", "192.168.30.115",                      "554  ·  RTSP"),
        ( 5, 14, 17, 8, "Sub-PLC #1",         ROYAL, "192.168.30.190",                          "Upper Rail Greasing"),
        (28, 8,  18, 8, "Sub-PLC #2",         ROYAL, "192.168.30.191",                          "Lock Bar Insert"),
        (52, 8,  18, 8, "Sub-PLC #3",         ROYAL, "192.168.30.192",                          "Lower Rail Greasing"),
...
def page_collector_hub(pdf):
    ...
    ax.text(cx, cy-7.6, "PLC  192.168.30.150 : 5002", ha="center", va="center",
