  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        /* List | Detail — 2 columns on desktop; the fixed 420px list column
           overflowed a phone, so stack to one column and tighten padding. */
        .pdca-main { padding: 20px 48px; display: grid; grid-template-columns: 420px 1fr; gap: 16px; }
        @media (max-width: 760px) {
          .pdca-main { grid-template-columns: 1fr; padding: 16px 14px; }
          .pdca-head { padding: 12px 14px 14px !important; }
        }
      `}</style>
      ...
      <div className="pdca-head" style={{ padding: "12px 48px 14px", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
