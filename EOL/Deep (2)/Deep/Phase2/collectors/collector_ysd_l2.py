#!/usr/bin/env python3
"""
AUTO-GENERATED COLLECTOR — YSD-SS
Line ID    : 4
Table      : ysd_l2_dashboard
Generated  : 2026-08-19 09:42:33
...
CONFIG = {
    "line_id":    4,
    "line_name":  "YSD-SS",
    "table_name": "ysd_l2_dashboard",
    "plc_ip":     "192.168.30.56",
    "plc_port":   5002,
    "ok_bit":     "D101",
    "ng_bit":     "D102",
    "status_addr":"D6005",
    ...
    "ideal_ct":   15.0,
    "max_ct":     16.0,
    "models":     {4: 'TRACK ASSY FRONT SEAT YTA 4 WAY INR RH', 6: 'TRACK ASSY FRONT SEAT 4 WAY INR LH', 7: 'TRACK ASSY FRONT SEAT 4 WAY OTR', 9: 'TRACK ASSY FRONT SEAT YHB 4 WAY OTR', 14: 'TRACK ASSY FRONT SEAT 4 WAY INR RH', 15: 'TRACK ASSY FRONT SEAT YTA 4 WAY INR LH'},
