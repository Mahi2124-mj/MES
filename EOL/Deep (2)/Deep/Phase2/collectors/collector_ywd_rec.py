#!/usr/bin/env python3
"""
AUTO-GENERATED COLLECTOR — YWD RECLINER
Line ID    : 10
Table      : ywd_recliner_dashboard
Generated  : 2026-07-13 12:20:19
...
CONFIG = {
    "line_id":    10,
    "line_name":  "YWD RECLINER",
    "table_name": "ywd_recliner_dashboard",
    "plc_ip":     "192.168.30.214",
    "plc_port":   502,
    "ok_bit":     "D101",
    "ng_bit":     "",
    "status_addr":"D6005",
    ...
    "ideal_ct":   19.58,
    "max_ct":     20.58,
    "models":     {1201: 'YWD REC RH', 1202: 'YWD REC LH'},
    ...
    "shifts":     {'A': {'start': '08:30:00', 'end': '17:15:00', 'plan': 1656, 'crosses_midnight': False}, 'B': {'start': '18:30:00', 'end': '03:15:00', 'plan': 1656, 'crosses_midnight': True}},
}
