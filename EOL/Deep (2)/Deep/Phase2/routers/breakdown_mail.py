...
def _format_breakdown_mail(level: dict, br: dict) -> tuple[str, str]:
    ...
    line   = br.get("line_name") or "Unknown line"
...
# Kick off the scheduler when this module is imported — in the ONE process
# elected to run background work.  Started per-process it would send a
# duplicate breakdown mail for every extra uvicorn worker.  See bg_leader.py.
