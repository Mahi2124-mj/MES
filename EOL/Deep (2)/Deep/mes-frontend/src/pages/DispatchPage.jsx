  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .dt-tabs::-webkit-scrollbar { height: 0; }
        @media (max-width: 600px) {
          .dt-tab { padding: 10px 12px; font-size: 11px; white-space: nowrap; letter-spacing: .04em; }
        }
      ...
      <div style={{ padding: "10px 48px 0", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
        ...
        <div className="dt-tabs" style={{ display: "flex", gap: 2, marginTop: 18 }}>
