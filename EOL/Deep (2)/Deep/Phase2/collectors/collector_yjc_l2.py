...
#!/usr/bin/env python3
"""
AUTO-GENERATED COLLECTOR — YJC-SS
Line ID    : 13
Table      : yjc_l2_dashboard
Generated  : 2026-07-04 16:18:19
...
CONFIG = {
    "line_id":    13,
    "line_name":  "YJC-SS",
    "table_name": "yjc_l2_dashboard",
    "plc_ip":     "192.168.10.126",
    "plc_port":   5002,
    "ok_bit":     "D601",
    "ng_bit":     "D602",
    "status_addr":"",
    ...
    "ideal_ct":   15.0,
    "max_ct":     16.0,
    "models":     {9: 'TRACK ASSY FRONT SEAT YHB 4 WAY OTR', 10: 'TRACK ASSY FRONT SEAT YHB 4 WAY INR RH', 11: 'TRACK ASSY FRONT SEAT YHB 4 WAY INR LH', 12: 'TRACK ASSY FRONT SEAT YCA 4 WAY INR LH', 14: 'TRACK ASSY FRONT SEAT YNC 4 WAY INR RH', 15: 'TRACK ASSY FRONT SEAT YNC 4 WAY INR LH', 16: 'TRACK ASSY FRONT SEAT YNC 4 WAY OTR'},
