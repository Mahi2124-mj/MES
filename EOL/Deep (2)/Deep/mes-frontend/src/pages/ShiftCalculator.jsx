  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        /* Inputs | Results — 2 columns on desktop; the fixed 380px inputs
           column overflowed a phone, so stack to one column and tighten the
           side padding below 700px. */
        .sc-grid { padding: 24px 48px; display: grid; grid-template-columns: 380px 1fr; gap: 24px; }
        @media (max-width: 700px) {
          .sc-grid { grid-template-columns: 1fr; padding: 16px 14px; }
        }
      `}</style>
