  ...
  return (
    <>
      <style>{`
        ...
        /* Phone: the absolute-centered title collided with the "Signed in as"
           pill on the right. Shrink the title and drop the pill (the user is
           already shown in the slide-nav), so nothing overlaps. */
        @media (max-width: 600px) {
          .pg-title { font-size: 18px; }
          .pg-pill { display: none; }
          .pg-topbar { padding: 0 14px 0 56px; }
          .pg-body { padding: 16px 14px 0; }
          .pg-fld { flex: 1 1 100%; }
          .pg-fld select, .pg-fld input { min-width: 0; width: 100%; }
        }
