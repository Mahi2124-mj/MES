...
app.add_middleware(
    ...
    allow_origins     = [
        ...
        "https://100.79.110.97",
        "http://localhost:5656", "http://127.0.0.1:5656", "http://192.168.10.185:5656",
    ],
...
def _start_weld_test_gen():
    """Synthetic robot-weld readings so the Weld Monitor charts are live
    until the real controller feed is wired in (disable: WELD_TEST_GEN=0)."""
    try:
        import threading
