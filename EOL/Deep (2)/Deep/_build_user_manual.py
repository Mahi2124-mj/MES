...
add_para(
    "The whole stack is on one PC for now (192.168.30.185). Everything is "
...
add_para('Server PC: 192.168.30.185 (also reachable as 127.0.0.1).', bold=True)

add_table(
    ["IP", "Port", "Service", "Notes"],
    [
        ["192.168.30.185", "8080", "MES Backend (FastAPI)",         "All MES API endpoints"],
        ["192.168.30.185", "5656", "MES Frontend (Vite)",           "Operator dashboard, admin"],
        ["192.168.30.185", "5000", "Camera CMS API (Flask)",        "Camera + cycle endpoints"],
        ["192.168.30.185", "8050", "Camera CMS MJPEG Streams",      "Live preview tiles"],
        ["192.168.30.185", "5173", "Camera CMS Frontend (Vite)",    "CMS admin portal"],
        ["192.168.30.10", "5432", "PostgreSQL (energydb)",         "All persistent data. user postgres / tbdi@123"],
        ["192.168.30.150", "5002", "Main PLC (Mitsubishi MC4E)",    "YNC-SS line. L108 = OK, L109 = NG"],
        ["192.168.30.190", "5002", "Sub-PLC #1 — Upper Rail Greasing M/c", "M100 cycle pulse"],
        ["192.168.30.191", "5002", "Sub-PLC #2 — Lock Bar Insert M/c",     "X3 cycle pulse"],
        ["192.168.30.192", "5002", "Sub-PLC #3 — Lower Rail Greasing M/c", "M100 cycle pulse"],
        ["192.168.30.115", "554",  "Hikvision RTSP camera (final station)", "User admin / admin123"],
    ],
...
add_bullet("MES dashboard: http://192.168.30.185:5656")
add_bullet("CMS portal:    http://192.168.30.185:5173")
