...
import {
  ...
  Video, FileBarChart, Clock, Layers
} from 'lucide-react'
import logo from '../assets/logo.jpg'

// Sidebar redesigned per user request (2026-05-13):
//   "Masters → Camera Admin" with just Zones/Lines/Machines.
//   PLCs, Cameras, separate "Camera Config" page, and "Reports" are
//   removed — all those fields now live inside the Machine Detail
//   page so a camera can be set up from one place.
//   Camera Grid stays under Monitor.
const NAV = [
  { label: 'Dashboard', to: '/', icon: LayoutDashboard },
  {
    label: 'Camera Admin', icon: Database,
    children: [
